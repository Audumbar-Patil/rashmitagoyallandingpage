...
export function EventContent() {
  return (
    <section id="schedule" className="py-8 px-8 lg:py-20">
      <div className="mb-8">
        <div className="w-full flex mb-8 flex-col items-center">
          <div className="h-12 w-72 md:w-96 bg-gray-200 rounded-lg flex">
            <button className="flex-1 font-medium bg-white rounded-lg m-1 text-gray-900">
              Day 1
            </button>
            <button className="flex-1 font-medium text-gray-600 hover:text-gray-900">
              Day 2
            </button>
            <button className="flex-1 font-medium text-gray-600 hover:text-gray-900">
              Day 3
